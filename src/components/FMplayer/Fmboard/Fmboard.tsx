    ...
    <>
      <div className={styles.contanier}>
        ...
        <div className={styles.song}>
          ...
          <div className={styles.speak} onClick={()=>history.replace(`/zhubo/${props.board.diantai.id}`)}> <span className={styles.speaker}>{props.board.speak}</span>
            {/* 加关注 */}
            {lookAt
              ?
              <Tag
